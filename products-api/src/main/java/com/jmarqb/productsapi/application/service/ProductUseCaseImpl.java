...
public class ProductUseCaseImpl implements ProductUseCase {
    ...
    private void updateProductFields(Product actualProduct, Product dataToUpdateProduct) {
        if (dataToUpdateProduct.getName() != null) actualProduct.setName(dataToUpdateProduct.getName());
        if (dataToUpdateProduct.getDescription() != null)
            actualProduct.setDescription(dataToUpdateProduct.getDescription());
        if (dataToUpdateProduct.getPrice() != null) actualProduct.setPrice(dataToUpdateProduct.getPrice());
        if (dataToUpdateProduct.getStock() != null) actualProduct.setStock(dataToUpdateProduct.getStock());
    }
}
